...
Сценарий: Я создаю перемещение товара в офис на Ленина
...
*Создание Акта
	...
	Тогда открылось окно "Списание недостач товаров (создание)*"
	И из выпадающего списка с именем 'АналитикаРасходов' я выбираю точное значение "Бердск - Ленина, 89  (Новосибирская область)"
