...
Сценарий: Я создаю ордер и акт на оприходование
...
*Содзание акта
	Когда открылось окно 'Ордер на отражение излишков товаров АС* от *'
	...
	Тогда открылось окно 'Оприходование излишков товаров АС* от *'
	И я нажимаю на кнопку с именем 'ФормаПровести'
