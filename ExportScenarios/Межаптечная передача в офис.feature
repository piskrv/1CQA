...
*Создание ордера 
	...
	Когда открылось окно "Ордер на отражение недостач товаров АСА1-* от *"
...
*Создание Акта
	...
	Тогда открылось окно "Списание недостач товаров (создание)"
	И я нажимаю кнопку выбора у поля с именем 'АналитикаРасходов'
	Тогда открылось окно "Найти"
	И в поле с именем 'Pattern' я ввожу текст "Аптечная сеть Фармакопейка ООО (Омская обл, г. Омск, ул. Дианова, дом № 39)"
	И я нажимаю на кнопку с именем 'Find'
	Тогда открылось окно "Контрагенты"
	И в таблице 'Список' я активизирую поле с именем 'Наименование'
	И в таблице 'БизнесРегионы' я активизирую поле с именем 'БизнесРегионыНаименование'
	И в таблице 'Список' я перехожу к строке:
		| "Бизнес-регион" | "Клиент" | "Наименование"                                                                |
		| "Омская обл"    | "Да"     | "Аптечная сеть Фармакопейка ООО (Омская обл, г. Омск, ул. Дианова, дом № 39)" |
	Тогда открылось окно "Найти"
	И я нажимаю на кнопку с именем 'Find'
	Тогда открылось окно "Контрагенты"
	И в таблице 'Список' я активизирую поле с именем 'Наименование'
