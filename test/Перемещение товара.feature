...
Сценарий: Я создаю перемещение товара из "Помещение1" В "Помещение2" //'[Помещение]'
И В командном интерфейсе я выбираю "Склад и доставка" "Ордера на перемещение товаров"
Тогда открылось окно "Ордера на перемещение товаров"
...
Тогда открылось окно "Ордер на перемещение товаров АСА1-* от *"
