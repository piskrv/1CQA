...
//Сценарий: Создание приобретения и прием товара
	...
	*Создание товара
		И Я создаю товар с Артикулом: "3172430" ценой: "20" ценой зарегистрированной: "2" И количеством: "3"
		И Я создаю товар с Артикулом: "3174665" ценой: "70" ценой зарегистрированной: "20" И количеством: "5"
...
//	Сценарий: Создание корректировки на излишки
	...
	*Создание товара
		И Я создаю товар с Артикулом: "3172430" ценой: "20" ценой зарегистрированной: "2" И количеством: "1"
		И Я создаю товар с Артикулом: "3174665" ценой: "70" ценой зарегистрированной: "20" И количеством: "2"
